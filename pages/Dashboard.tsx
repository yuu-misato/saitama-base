...
const Dashboard: React.FC = () => {
  ...
  // Authentication logic moved to useAuth hook.
  // Debug admin logic can be re-implemented if needed, but removed for optimization.
  ...
  if (tempUser || isEditingProfile) {
    return (
      <RegistrationModal
        initialNickname={tempUser?.nickname || user?.nickname || ''}
